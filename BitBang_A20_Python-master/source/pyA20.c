...
#define PIN_UEXT1_3		SUNXI_GPI(12)
#define PIN_UEXT1_4		SUNXI_GPI(13)
#define PIN_UEXT1_5		SUNXI_GPB(20)
#define PIN_UEXT1_6		SUNXI_GPB(21)
#define PIN_UEXT1_7		SUNXI_GPC(22)
#define PIN_UEXT1_8		SUNXI_GPC(21)
#define PIN_UEXT1_9		SUNXI_GPC(20)
#define PIN_UEXT1_10	SUNXI_GPC(19)
...
// GPIO-3	
    ...
    PyModule_AddObject(module, "UEXT1_3", Py_BuildValue("i", PIN_UEXT1_3));
    PyModule_AddObject(module, "UEXT1_4", Py_BuildValue("i", PIN_UEXT1_4));
    PyModule_AddObject(module, "UEXT1_5", Py_BuildValue("i", PIN_UEXT1_5));
    PyModule_AddObject(module, "UEXT1_6", Py_BuildValue("i", PIN_UEXT1_6));
    PyModule_AddObject(module, "UEXT1_7", Py_BuildValue("i", PIN_UEXT1_7));
    PyModule_AddObject(module, "UEXT1_8", Py_BuildValue("i", PIN_UEXT1_8));
    PyModule_AddObject(module, "UEXT1_9", Py_BuildValue("i", PIN_UEXT1_9));
    PyModule_AddObject(module, "UEXT1_10", Py_BuildValue("i", PIN_UEXT1_10));
